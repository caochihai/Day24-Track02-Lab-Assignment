...
def validate_anonymized_data(filepath: str) -> dict:
    ...
    # Check 1: Không còn CCCD gốc dạng số thuần túy (giả sử nguyên bản chỉ gồm số)
    # Sau anonymization, cccd có thể chứa ký tự ẩn danh hoặc là số fake khác.
    # Trong bài lab này, chúng ta replace bằng số fake, nên ta check logic khác:
    # Ví dụ: check xem có dòng nào trùng với raw data không (nếu có access raw)
